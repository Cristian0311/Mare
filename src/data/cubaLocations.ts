...
export const cubaLocations: Province[] = [
  ...
  },
  {
    ...
    activa: true,
    municipios: [
      { id: 'playa', nombre: 'Playa', activo: true, precioEntregaMN: 400 },
      { id: 'plaza-de-la-revolucion', nombre: 'Plaza de la Revolución', activo: true, precioEntregaMN: 300 },
      { id: 'centro-habana', nombre: 'Centro Habana', activo: true, precioEntregaMN: 300 },
      { id: 'la-habana-vieja', nombre: 'La Habana Vieja', activo: true, precioEntregaMN: 300 },
      { id: 'regla', nombre: 'Regla', activo: true, precioEntregaMN: 500 },
      { id: 'la-habana-del-este', nombre: 'La Habana del Este', activo: true, precioEntregaMN: 650 },
      { id: 'guanabacoa', nombre: 'Guanabacoa', activo: true, precioEntregaMN: 600 },
      { id: 'san-miguel-del-padron', nombre: 'San Miguel del Padrón', activo: true, precioEntregaMN: 550 },
      { id: 'diez-de-octubre', nombre: 'Diez de Octubre', activo: true, precioEntregaMN: 400 },
      { id: 'cerro', nombre: 'Cerro', activo: true, precioEntregaMN: 350 },
      { id: 'marianao', nombre: 'Marianao', activo: true, precioEntregaMN: 450 },
      { id: 'la-lisa', nombre: 'La Lisa', activo: true, precioEntregaMN: 550 },
      { id: 'boyeros', nombre: 'Boyeros', activo: true, precioEntregaMN: 600 },
      { id: 'arroyo-naranjo', nombre: 'Arroyo Naranjo', activo: true, precioEntregaMN: 500 },
      { id: 'cotorro', nombre: 'Cotorro', activo: true, precioEntregaMN: 700 }
    ]
  },
  {
    id: 'mayabeque',
